 ...
 *
 * Renders the user account creation form.
 *
 * Features:
 * - Centered "Card" layout (consistent with Login).
 * - Inputs for Username, Password, and Password Confirmation.
 * - Displays validation errors passed from the Controller (e.g., "Username taken").
 * - Includes a language switcher and navigation links to Login/Home.
 *
 * Data Dependencies:
...
<head>
    ...
    <style>
        :root {
            /* Color Palette (Consistent with Homepage/Login) */
            --primary: #696FC7;
...
<body>
    ...
    <div class="register-card">
        ...
        <form action="/register" method="POST">
            ...
            <input type="password" id="password_repeat" name="password_repeat" required placeholder="••••••••">
